...
public class UpdatedBlacklistRequest {
    ...
    public UpdatedBlacklistRequest() {
    }

    public UpdatedBlacklistRequest(int id, String reason, LocalDate date, Applicant applicationId) {
        this.id = id;
        this.reason = reason;
        this.date = date;
        this.applicationId = applicationId;
