...
public class GetAllBootcampResponse {
    ...
    public GetAllBootcampResponse(int id, String name, Instructor instructorId, Date startDate, Date endDate, BootcampState bootcampState, List<Application> application) {
        this.id = id;
        this.name = name;
        this.instructorId = instructorId;
        this.startDate = startDate;
