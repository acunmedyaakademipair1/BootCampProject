...
public class GetUserResponses {
    ...
    public GetUserResponses(int id, String userName, String firstName, String lastName, int dateOfBirth, int nationalIdentity, String email, int password) {
        this.id = id;
